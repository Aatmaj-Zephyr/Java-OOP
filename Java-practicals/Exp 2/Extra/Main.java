...
public class Main
{
 ...
 vector A = new vector(my_Scanner.nextDouble(),my_Scanner.nextDouble(),my_Scanner.nextDouble());
 vector B =  new vector(my_Scanner.nextDouble(),my_Scanner.nextDouble(),my_Scanner.nextDouble());
